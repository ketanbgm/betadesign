...
<script>
	...
	var url=pbaseurl+"index.php/cproduct/loadProduct";
	$(function(){
...
<div class="panel panel-default " style="border-collapse:0px solid red;">
    <div class="panel-heading">Lookup Product<span class="pull-right"><a href="<?php echo $base; ?>index.php/cproduct/" class="lookupclass">New</a></span></div>
