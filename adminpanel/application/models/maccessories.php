...
class maccessories extends CI_Model
{	
	public function saveAccessories($productstore)
	{
		$arrStatus=NULL;
		$this->db->query("Begin");
		...
		{*/
			...
			//{
				...
				$sql="Insert into accessories(aname,aimgname,aprice,adiscription,pid) VALUES('".$aname."','".$aimgname."',".$aprice.",'".$adescription."',".$pid.")";//echo $sql;//die();
				//echo $sql;die();
		...
		else
		{
			...
			$arrStatus['status'] ='OK';$arrStatus['msg'][]='Accessory Saved';$arrStatus['tag'][]='show';$arrStatus['id']=$id;
		}
		return $arrStatus;
	}
