    ...
    a.prototype = {
        ...
        initFilter: function() {
            jQuery.fn.slider && (jQuery("#price-filter-range").slider({
                ...
                values: [0, 20000],
                slide: function(a, b) {
                    jQuery("#price-filter-amount").text("Rs" + b.values[0] + " - Rs" + b.values[1])
                }
            }), jQuery("#price-filter-amount").text("Rs" + jQuery("#price-filter-range").slider("values", 0) + " - Rs" + jQuery("#price-filter-range").slider("values", 1)))
        },
