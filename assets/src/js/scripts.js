	...
	initFilter : function() {
		...
		jQuery( "#price-filter-range" ).slider({
			...
			slide: function( event, ui ) {
				jQuery( "#price-filter-amount" ).text( "Rs" + ui.values[ 0 ] + " - Rs" + ui.values[ 1 ] );
			}
	    });
	    jQuery( "#price-filter-amount" ).text( "Rs" + jQuery( "#price-filter-range" ).slider( "values", 0 ) +
	      " - Rs" + jQuery( "#price-filter-range" ).slider( "values", 1 ) );
	},
